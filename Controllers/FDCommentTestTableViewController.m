//
//  FDCommentTestTableViewController.m
//  foodudes2.0
//
...
@interface FDCommentTestTableViewController ()
@property (weak, nonatomic) IBOutlet UITextField *commentTextField;


@end

@implementation FDCommentTestTableViewController
...
- (IBAction)commentButtonPressed:(id)sender {
    ...
    PFObject * post = self.postArray[1];
